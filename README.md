...
Le signal creative est donc bruité, en raison à la fois de la subjectivité du concept et de son taux de base très faible. De plus, tout classement construit sur ces votes (type Bradley-Terry) mesure la performance sur un sous-échantillon biaisé vers les réponses longues et les sujets engageants, ce qui fausse en particulier l'évaluation de la créativité.
